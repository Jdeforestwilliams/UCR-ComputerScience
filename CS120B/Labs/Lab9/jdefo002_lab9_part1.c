/*   jdefo002_lab9_part1.c - 5-13-13
*    Name & E-mail: Joshua DeForest-Williams jdefo002@ucr.edu
*    CS Login: jdefo002
*    Partner(s) Name & E-mail: Ariana Dejaco adeja001@ucr.edu
*    Lab Section: 22
*    Assignment: Lab # 9 Exercise # 1
*    Exercise Description: The goal of this part of the lab is to produce
*    a middle C on the speaker when a button is pressed and held.
