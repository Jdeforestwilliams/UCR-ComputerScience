/*   jdefo002_lab9_part5.c - 5-13-13
*    Name & E-mail: Joshua DeForest-Williams jdefo002@ucr.edu
*    CS Login: jdefo002
*    Partner(s) Name & E-mail: Ariana Dejaco Adeja001@ucr.edu
*    Lab Section: 22
*    Assignment: Lab # 9  Exercise # 5 Challenge
*    Exercise Description:Using the ATmega32’s built in PWM functionality,
*    create a piano with seven different tones that can be used to play a
*    song.
*
...
#include "Buttons.h"
#include "KeyPad.h"
#include "Speaker_PartChallange.h"
#include "Timer0.h"
#include "Schedular.h"
