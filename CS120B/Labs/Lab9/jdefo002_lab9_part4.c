/*   jdefo002_lab9_part4.c - 5-13-13
*    Name & E-mail: Joshua DeForest-Williams jdefo002@ucr.edu
*    CS Login: jdefo002
*    Partner(s) Name & E-mail: Ariana Dejaco Adeja001@ucr.edu
*    Lab Section: 22
*    Assignment: Lab # 9  Exercise # 4 Challenge
*    Exercise Description: Expand upon part 3 of the lab by adding three
*    additional buttons with the following functionality. One button will
*    toggle sound on/off. The other two buttons will be used to raise or
*    lower the tone. Holding the tone buttons down should raise/lower the
*    tone slowly (A note every second will be slow enough).
*
