/*   jdefo002_lab9_part3.c - 5-13-13
*    Name & E-mail: Joshua DeForest-Williams jdefo002@ucr.edu
*    CS Login: jdefo002
*    Partner(s) Name & E-mail: Ariana Dejaco adeja001@ucr.edu
*    Lab Section: 22
*    Assignment: Lab # 9 Exercise # 3
*    Exercise Description:This section will be using the PWM functionality
*    on timer/counter 2 of the ATmega32. Since we will be using a different
*    timer than the one used in previous labs, the changes made to TCCR0
*    and OCR0 can be reverted back to their original values.
*
