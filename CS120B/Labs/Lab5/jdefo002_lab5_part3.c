/* jdefo002_lab5_part3.c - April 22, 2013
 * Name: Joshua DeForest-Williams E-mail jdefo002@ucr.edu
 * CS Login: jdefo002
 * Partner Name: Ariana DeJaco Email adejaoo1@ucr.edu
 * Lab Section: 022
 * Assignment: Lab#5 Exercise#3
 * Exercise Description: Using the seven-segment display, buttons,
 * and LEDs, create a very simple game. It can be any game, and it 
 * can be very simple -- but each student pair must create and 
 * implement their own game. Use a state machine (not synchronous) 
 * as appropriate. 
 */
...
enum Counter_States { InitReset, LEDLight, WaitForButtonPress, WaitForButtonRelease, ErrorState } CounterState;
