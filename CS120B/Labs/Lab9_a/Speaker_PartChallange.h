/*
 * Speaker_PartChallange.h
 *
 * Created: 5/13/2013 1:55:57 PM
 *  Author: Ariana DeJaco
 */ 

#ifndef SPEAKER_PARTCHALLANGE_H_
#define SPEAKER_PARTCHALLANGE_H_
...
int SpeakerTask(int currentState)
{
	...
	{
		case SpeakerOff:
			if ((KeyPadState != KeyPadOff) && (KeyPadState != OtherKey))
...
#endif /* SPEAKER_PARTCHALLANGE_H_ */